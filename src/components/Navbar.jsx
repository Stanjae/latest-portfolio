...
import { AppBar, Toolbar, Typography, IconButton, Drawer, List, Divider, ListItemText, ListItemButton } from '@mui/material';
...
const Navbar = () => {
  ...
  return (
    <div>
      <AppBar sx={stylesio} color="bgcolor" position="static">
        <Toolbar>
          ...
          <Typography color={'neutral.main'} variant="h5" sx={{ flexGrow: 1 }}>
            Stan<Typography color={'primary'} variant='h5' component={'span'}>jhae</Typography>
          </Typography>
      ...
      <Drawer
      sx={{width:300, bgcolor:'bgcolor.sidebg'}} anchor="left" open={open} onClose={handleDrawerClose}>
       {/*  <List sx={{width:300}}>
        ...
        <List sx={{width:300, bgcolor:'bgcolor.sidebg'}}  component="nav" aria-label="main mailbox folders">
